...
<div id="main">
    <div class="wrapper">
        ...
        <?php echo form_open('dologin',array('id'=>'login-form','onsubmit'=> 'return checkInput();')) ?>
        <div class="login-cont">
            ...
            <div class="input-item-cont input-item-saveun-cont cf">
                <label class="pull-left" >
                    <input type="checkbox" id="saveusername" name="saveusername" value="" <?php echo empty( $_COOKIE['username']) ? '' : 'checked="checked"';?>/>
            ...
            <div class="input-item-cont">
                ...
                <a href="<?php echo site_url('register');?>"><span class="inblo vm pointer" id="register-link">免费注册</span></a>
            </div>
        </div>
        <?php echo form_close() ?>
    </div>
